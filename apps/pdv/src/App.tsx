    ...
    <div className="pdv-app">
      <aside className="pdv-rail">
        ...
        <div className="rail-nav">
          <div className="rail-item selected" title="Venda">
            ▣<span>Venda</span>
          </div>
          <div className="rail-item" title="Caixa">
            ▤<span>Caixa</span>
          </div>
          <div className="rail-item" title="Histórico">
            ◷<span>Histórico</span>
          </div>
        </div>
        ...
        <div className="pdv-body">
          <section className="sale-area">
            ...
            <div className="items-empty">
              ...
              <p>
                Os produtos do CompreMai$ Estivas aparecerão aqui depois do cadastro e da integração
                com a API.
              </p>
            </div>
          ...
          <aside className="checkout-area">
            ...
            <p className="checkout-note">
              O fechamento de caixa e a emissão fiscal serão habilitados após os testes operacionais
              e fiscais.
            </p>
          </aside>
        </div>
